...
class AppTicketViewCtrl: UIViewController, UITableViewDataSource, UITableViewDelegate {
    @IBOutlet var appTicketTableViewCell: UITableView!
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let mycell:AppTicketTableViewCell = tableView.dequeueReusableCell(withIdentifier: "cell") as! AppTicketTableViewCell
