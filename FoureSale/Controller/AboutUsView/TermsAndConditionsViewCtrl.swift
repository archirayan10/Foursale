//
//  TermsAndConditionsViewCtrl.swift
//  FoureSale
//
...
class TermsAndConditionsViewCtrl: UIViewController {
    ...
    */
    func GetTermsAndCondationData(){
        //get_high_score.php?from=1472409001482&number=10&to=1493657787867
        EZLoadingActivity.show("Loading...", disableUI: false)
        
        DispatchQueue.global(qos: .background).async {
            
            let myUrl = URL(string: GlobleUrl.BASEURL + "terms-condition.php");
                    ...
                    DispatchQueue.main.async {
                        ...
                        if let parseJSON = json {
                            ...
                            if status == "true"{
                                ...
                                self.termsAndCondationLabel.text = teamp as? String
                                self.termsAndCondationLabel.sizeToFit()
